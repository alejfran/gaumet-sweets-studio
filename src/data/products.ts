...
export const products: Product[] = [
  // Cookies
  {
    ...
    price: "3,50€",
    images: [dubaiImage, cookiesImage, cheesecakeImage],
    features: [
      "Tamaño XXL (120g)",
      "Chocolate belga 70%",
      "Masa fermentada 24h",
  ...
  },
  {
    ...
    price: "3,75€",
    images: [rollsHeroImage, dubaiImage, cookiesImage],
    features: [
      "Cacao premium",
  ...
  },
  {
    ...
    price: "4,00€",
    images: [cookiesImage, dubaiImage, cheesecakeImage],
    features: [
  ...
  },
  {
    ...
    price: "3,75€",
    images: [cheesecakeImage, cookiesImage, dubaiImage],
    features: [
      "Color único",
      "Chocolate blanco",
      "Textura suave",
  ...
  // Rolls
  {
    ...
    price: "3,80€",
    images: [rollsHeroImage, cookiesImage, dubaiImage],
    features: [
      "Canela de Ceilán",
      "Glaseado casero",
      "Masa fermentada",
  ...
  },
  {
    ...
    images: [cheesecakeImage, dubaiImage, cookiesImage],
    features: [
  ...
  },
  {
    ...
    price: "26,00€ (entera) / 3,80€ (porción)",
    images: [cookiesImage, cheesecakeImage, dubaiImage],
    features: [
      "Base 100% Oreo",
      "Trozos generosos",
      "Cremosidad extra",
